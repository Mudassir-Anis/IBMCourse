const employees = [
  ...
  function calculateTotalSalaries() {
    const totalSalaries = employees.reduce((total,employee) => employee.salary + total,0);
  ...
  function displayHREmployees() {
    ...
    function findEmployeeById(employeeId) {
        ...
        if(foundEmployee) {
            ...
            document.getElementsById('employeeDetails').innerHTML = 'no employee has been found with this ID';
        }
